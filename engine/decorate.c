...
// 'DoomPlayer' stuff
static const ei_player_t ei_player = {.view_height = 41 * FRACUNIT,
...
static mobjinfo_t default_powerup = {.spawnhealth = 1000,
                                     .reactiontime = 8,
                                     .radius = 20 << FRACBITS,
                                     .height = 16 << FRACBITS,
                                     .step_height = 24 * FRACUNIT,
...
const dec_flag_t mobj_flags0[] = {
    ...
    // terminator
    {NULL}};
const dec_flag_t mobj_flags1[] = {{"ismonster", MF1_ISMONSTER},
...
// special inventory
static const uint8_t* powerup_special[] = {"BackpackItem", "MapRevealer",
                                           // terminator
                                           NULL};
