...
void
font_menu_text(int32_t x, int32_t y, const uint8_t* text)
{
...
static __attribute((regparm(2), no_caller_saved_registers)) void hud_font_init()
{
	int32_t lump;
...
static __attribute((regparm(2), no_caller_saved_registers)) void finale_text()
{
	uint8_t* ptr;
	uint8_t bkup;
	int32_t count;
